      ...
      <div className="relative">
        ...
        {experiences.map((experience, index) => (
          ...
          >
            ...
            {/* Content Section */}
            <div
              className={`w-full min-w-[350px] sm:max-w-md p-4 sm:p-8 rounded-2xl shadow-2xl border border-white bg-gray-900 backdrop-blur-md shadow-[0_0_20px_1px_rgba(130,69,236,0.3)] ${
              ...
              <div className="mt-4">
                ...
                <ul className="flex flex-wrap mt-2">
                  {experience.skills.map((skill, index) => (
                    <li
                      key={index}
                      className="bg-[#f64040] text-gray-300 px-4 py-1 text-xs sm:text-sm rounded-lg mr-2 mb-2 font-semibold border border-gray-400 hover:border-red-700"
                    >
                      {skill}
                    </li>
                  ))}
